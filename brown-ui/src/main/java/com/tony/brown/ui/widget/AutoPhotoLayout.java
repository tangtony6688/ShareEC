package com.tony.brown.ui.widget;
...
public class AutoPhotoLayout extends LinearLayoutCompat {
    ...
    public final void setDelegate(BrownDelegate delegate) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < cCount; i++) {
            ...
            //换行
            if (lineWith + childWidth > sizeWith - getPaddingStart() - getPaddingEnd()) {
                //对比得到最大宽度
        ...
        setMeasuredDimension(
                modeWith == MeasureSpec.EXACTLY ? sizeWith : width + getPaddingStart() + getPaddingEnd(),
