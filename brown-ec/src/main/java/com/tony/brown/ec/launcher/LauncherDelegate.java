...
import com.tony.brown.util.timer.ITimerListener;
...
public class LauncherDelegate extends BrownDelegate implements ITimerListener {
    ...
    private void checkIsShowScroll() {
        if (!BrownPreference.getAppFlag(ScrollLauncherTag.HAS_FIRST_LAUNCHER_APP.name())) {
