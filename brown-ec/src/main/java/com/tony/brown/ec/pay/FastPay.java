...
public class FastPay implements View.OnClickListener {
    ...
    private FastPay(BrownDelegate delegate) {
        this.mActivity = delegate.getProxyActivity();
        this.mDialog = new AlertDialog.Builder(delegate.getContext()).create();
    }

    public static FastPay create(BrownDelegate delegate) {
        ...
        RestClient.builder()
                ...
                .success(new ISuccess() {
                    ...
                    public void onSuccess(String response) {
                        ...
                        BrownLogger.d("PAY_SIGN", paySign);
                        //必须是异步的调用客户端支付接口
    ...
    private void weChatPay(int orderId) {
        ...
        BrownLogger.d("WX_PAY", weChatPrePayUrl);

        final IWXAPI iwxapi = BrownWeChat.getInstance().getWXAPI();
        final String appId = Brown.getConfiguration(ConfigKeys.WE_CHAT_APP_ID);
